...
export class AppComponent implements OnInit {
  ...
  public capture2() {
    this._timer = setInterval(() => {
      var context = this.canvas2.nativeElement.getContext("2d").drawImage(this.video.nativeElement,520,50,640,480, 0, 0, 800, 600);
      this.captures2.push(this.canvas2.nativeElement.toDataURL("image/png"));
    }, 5000);
  }
